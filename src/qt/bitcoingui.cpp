 ...
 * The TokenOfDigitalMoney Developers 2018-2020
 */
...
TokenOfDigitalMoneyGUI::TokenOfDigitalMoneyGUI(QWidget *parent):
    QMainWindow(parent),
    clientModel(0),
    walletModel(0),
    toolbar(0),
    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("TokenOfDigitalMoney") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    ...
    setObjectName("TokenOfDigitalMoney");
    setStyleSheet("#TokenOfDigitalMoney { background-image: url(:/images/background_light); }");//background-color: #e6e6e6; color: #333333;
...
TokenOfDigitalMoneyGUI::~TokenOfDigitalMoneyGUI()
{
...
void TokenOfDigitalMoneyGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a TokenOfDigitalMoney address"));
    ...
    aboutAction = new QAction(QIcon(fUseDarkTheme ? ":/icons/dark/bitcoin-dark" : ":/icons/bitcoin"), tr("&About TokenOfDigitalMoney"), this);
    aboutAction->setToolTip(tr("Show information about TokenOfDigitalMoney"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for TokenOfDigitalMoney"));
    ...
    editConfigAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit TokenOfDigitalMoney.conf"), this);
    editConfigAction->setToolTip(tr("Edit the configuration file for TokenOfDigitalMoney"));
    editConfigExtAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit TokenOfDigitalMoney.conf (external)"), this);
    editConfigExtAction->setToolTip(tr("Edit the configuration file for TokenOfDigitalMoney (external editor)"));
    openDataDirAction = new QAction(QIcon(":/icons/folder"), tr("&Open data dir"), this);
    openDataDirAction->setToolTip(tr("Open the directory where TokenOfDigitalMoney data is stored"));
...
//void TokenOfDigitalMoneyGUI::createMenuBar()
//{
//#ifdef Q_OS_MAC
...
void TokenOfDigitalMoneyGUI::createToolBars()
{
...
void TokenOfDigitalMoneyGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("TokenOfDigitalMoney client") + QString(" ") + tr("[testnet]"));
...
void TokenOfDigitalMoneyGUI::setWalletModel(WalletModel *walletModel)
{
...
void TokenOfDigitalMoneyGUI::setMessageModel(MessageModel *messageModel)
{
...
void TokenOfDigitalMoneyGUI::createTrayIcon()
{
    QMenu *trayIconMenu;
#ifndef Q_OS_MAC
    ...
    trayIcon->setToolTip(tr("TokenOfDigitalMoney client"));
...
#ifndef Q_OS_MAC
void TokenOfDigitalMoneyGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void TokenOfDigitalMoneyGUI::optionsClicked()
{
...
void TokenOfDigitalMoneyGUI::aboutClicked()
{
    AboutDialog dlg;
...
void TokenOfDigitalMoneyGUI::aboutQtExt_Internal()
{
    aboutQtAction->triggered();
}

void TokenOfDigitalMoneyGUI::aboutQtExt_Static()
{
    guiref->aboutQtExt_Internal();
}

void TokenOfDigitalMoneyGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
    ...
    //labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TokenOfDigitalMoney network", "", count));
}

void TokenOfDigitalMoneyGUI::setNumBlocks(int count)
{
    QString tooltip;
...
void TokenOfDigitalMoneyGUI::message(const QString &title, const QString &message, bool modal, unsigned int style)
{
    QString strTitle = tr("TokenOfDigitalMoney") + " - ";
...
void TokenOfDigitalMoneyGUI::error(const QString &title, const QString &message, bool modal)
{
...
void TokenOfDigitalMoneyGUI::changeEvent(QEvent *e)
{
...
void TokenOfDigitalMoneyGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void TokenOfDigitalMoneyGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;
    ...
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(TokenOfDigitalMoneyUnits::formatWithUnit(clientModel->getOptionsModel()->getDisplayUnit(), nFeeRequired));
...
void TokenOfDigitalMoneyGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
    ...
    notificator->notify(Notificator::Information,
                        (amount)<0 ? tr("Sent transaction") :
                          ...
                          tr("Date: %1\n"
                             ...
                             "Address: %4\n")
                          .arg(date)
                          .arg(TokenOfDigitalMoneyUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                          .arg(type)
                          .arg(address), icon);
}

void TokenOfDigitalMoneyGUI::incomingMessage(const QModelIndex & parent, int start, int end)
{
    if(!messageModel)
        return;
...
void TokenOfDigitalMoneyGUI::clearWidgets()
{
...
void TokenOfDigitalMoneyGUI::gotoMasternodeManagerPage()
{
    ...
    setStyleSheet("#TokenOfDigitalMoney { background-image: url(:/images/background_light_alt); }");
}

void TokenOfDigitalMoneyGUI::gotoBlockBrowser()
{
...
void TokenOfDigitalMoneyGUI::gotoOverviewPage()
{
    ...
    setStyleSheet("#TokenOfDigitalMoney { background-image: url(:/images/background_light); }");
}

void TokenOfDigitalMoneyGUI::gotoHistoryPage()
{
...
void TokenOfDigitalMoneyGUI::gotoHistoryPage_static()
{
    guiref->gotoHistoryPage();
}

void TokenOfDigitalMoneyGUI::gotoAddressBookPage()
{
...
void TokenOfDigitalMoneyGUI::gotoReceiveCoinsPage()
{
...
void TokenOfDigitalMoneyGUI::gotoSendCoinsPage()
{
...
void TokenOfDigitalMoneyGUI::gotoSignMessageTab(QString addr)
{
...
void TokenOfDigitalMoneyGUI::gotoVerifyMessageTab(QString addr)
{
...
void TokenOfDigitalMoneyGUI::gotoMessagePage()
{
...
void TokenOfDigitalMoneyGUI::gotoSettingsPage()
{
...
void TokenOfDigitalMoneyGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void TokenOfDigitalMoneyGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid TokenOfDigitalMoney address or malformed URI parameters."));
    }

    event->acceptProposedAction();
}

void TokenOfDigitalMoneyGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void TokenOfDigitalMoneyGUI::setWalletUnlockStakingOnly()
{
...
void TokenOfDigitalMoneyGUI::setUnencrypted()
{
    changePassphraseAction->setEnabled(false);
...
void TokenOfDigitalMoneyGUI::setUnlocked()
{
...
void TokenOfDigitalMoneyGUI::setLocked()
{
    changePassphraseAction->setEnabled(true);
    unlockWalletAction->setVisible(true);
    lockWalletAction->setVisible(false);
...
void TokenOfDigitalMoneyGUI::setEncryptionStatus(int status)
{
...
void TokenOfDigitalMoneyGUI::encryptWallet()
{
    if(!walletModel)
        return;
...
void TokenOfDigitalMoneyGUI::backupWallet()
{
...
void TokenOfDigitalMoneyGUI::importPrivateKey()
{
...
void TokenOfDigitalMoneyGUI::changePassphrase()
{
...
void TokenOfDigitalMoneyGUI::unlockWallet()
{
    if(!walletModel)
        return;
...
void TokenOfDigitalMoneyGUI::lockWallet()
{
    if(!walletModel)
        return;
...
void TokenOfDigitalMoneyGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void TokenOfDigitalMoneyGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void TokenOfDigitalMoneyGUI::updateWeight()
{
    if (!pwalletMain)
        return;
...
/*void TokenOfDigitalMoneyGUI::updateStakingIcon()
{
    updateWeight();
...
void TokenOfDigitalMoneyGUI::detectShutdown()
{
    if (ShutdownRequested())
        QMetaObject::invokeMethod(QCoreApplication::instance(), "quit", Qt::QueuedConnection);
}

/*void TokenOfDigitalMoneyGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0)
    {
...
void TokenOfDigitalMoneyGUI::editConfig()
{
...
void TokenOfDigitalMoneyGUI::editConfigExt()
{
...
void TokenOfDigitalMoneyGUI::openDataDir()
{
