...
extern TokenOfDigitalMoneyGUI* guiref;
...
/**
  TokenOfDigitalMoney GUI main class. This class represents the main window of the TokenOfDigitalMoney UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class TokenOfDigitalMoneyGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit TokenOfDigitalMoneyGUI(QWidget *parent = 0);
    ~TokenOfDigitalMoneyGUI();
    ...
    */
    ...
    /** Set the message model.
        The message model represents a TokenOfDigitalMoney  Note or D-Note, and offers secure messaging through a peer to peer
        relay.
    */
...
private slots:
    ...
    */
    ...
    /** Edit the TokenOfDigitalMoney.conf file */
    void editConfig();
    void editConfigExt();
