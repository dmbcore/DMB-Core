...
/** TokenOfDigitalMoney unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class TokenOfDigitalMoneyUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit TokenOfDigitalMoneyUnits(QObject *parent);

    /** TokenOfDigitalMoney units.
...
typedef TokenOfDigitalMoneyUnits::Unit TokenOfDigitalMoneyUnit;
