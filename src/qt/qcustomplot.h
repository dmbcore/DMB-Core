...
class QCP_LIB_DECL QCPAxis : public QCPLayerable
{
  ...
  Q_PROPERTY(bool rangeTokenOfDigitalMoneyersed READ rangeTokenOfDigitalMoneyersed WRITE setRangeTokenOfDigitalMoneyersed)
...
public:
  ...
  */
  ...
  bool rangeTokenOfDigitalMoneyersed() const { return mRangeTokenOfDigitalMoneyersed; }
  ...
  void setRangeTokenOfDigitalMoneyersed(bool reversed);
...
protected:
  ...
  // scale and range:
  QCPRange mRange;
  bool mRangeTokenOfDigitalMoneyersed;
