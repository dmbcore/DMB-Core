...
/**
 * Split TokenOfDigitalMoney command line into a list of arguments. Aims to emulate \c bash and friends.
 *
...
void RPCConsolesettings::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the TokenOfDigitalMoney RPC console.") + "<br>" +
