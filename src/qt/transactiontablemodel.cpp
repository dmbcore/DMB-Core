...
{
    columns << QString() <<  QString() << tr("Date") << tr("Type") << tr("Address") << TokenOfDigitalMoneyUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
{
	columns[Amount] = TokenOfDigitalMoneyUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
{
    QString str = TokenOfDigitalMoneyUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), wtx->credit + wtx->debit);
    if(showUnconfirmed)
    {
