...
void TransactionView::changedAmount(const QString &amount)
{
    ...
    // Replace "," by "." so TokenOfDigitalMoneyUnits::parse will not fail for users entering "," as decimal separator
    QString newAmount = amount;
    newAmount.replace(QString(","), QString("."));

    if(TokenOfDigitalMoneyUnits::parse(model->getOptionsModel()->getDisplayUnit(), newAmount, &amount_parsed))
    {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(TokenOfDigitalMoneyUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
...
void TransactionView::computeSum()
{
    ...
    QString strAmount(TokenOfDigitalMoneyUnits::formatWithUnit(nDisplayUnit, amount, true, TokenOfDigitalMoneyUnits::separatorAlways));
