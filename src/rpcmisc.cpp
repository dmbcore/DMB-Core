...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress <TokenOfDigitalMoney>\n"
            "Return information about <TokenOfDigitalMoney>.");
...
Value validatepubkey(const Array& params, bool fHelp)
{
    if (fHelp || !params.size() || params.size() > 2)
        throw runtime_error(
            "validatepubkey <TokenOfDigitalMoneypubkey>\n"
            "Return information about <TokenOfDigitalMoneypubkey>.");
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage <TokenOfDigitalMoney> <signature> <message>\n"
