...
Value pubkeyaliasservice(const Array& params, bool fHelp)
{
    ...
    if (fHelp  ||
        ...
        throw runtime_error(
                ...
                "  start        - Start pubkeyaliasservice configured in TokenOfDigitalMoney.conf\n"
                ...
                "  stop         - Stop pubkeyaliasservice configured in TokenOfDigitalMoney.conf\n"
    ...
    if(strCommand == "status")
    {
        ...
        if (ppas) mnObj.push_back(Pair("pubkey", CTokenOfDigitalMoneyAddress(ppas->pubkey.GetID()).ToString()));
