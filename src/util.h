...
extern int nAnonymizeTokenOfDigitalMoneyAmount;
...
inline uint32_t ByteTokenOfDigitalMoneyerse(uint32_t value)
{
...
{
    std::string s = strprintf("TokenOfDigitalMoney-%s", name);
